...
<div class="modal animate slideIn" id="archive_patient" tabindex="-1" aria-labelledby="archive_clinic_modals"
    aria-hidden="true">
            ...
            <div class="modal-body clinic-modal-body">
                ...
                <div class="row p-2">
                    ...
                    <p class="archive-clinic-modal-description text-center ">
                        The data of patients that are in archive mode won't be accessible, continue?
                    </p>
                </div>
                <div class="row p-2">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control border-left-0" id="password_input"
                                aria-describedby="password_input" required>
                        </div>
